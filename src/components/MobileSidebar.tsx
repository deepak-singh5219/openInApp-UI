...
const MobileSidebar = (props: Props) => {
  ...
  return (
<div className={`${!isOpen?"left-0":"-left-[600px]"} z-40 h-full fixed transition-all ease-in-out duration-600 lg:hidden w-72 lg:h-[90%] flex flex-row`}>
  <div className="relative flex py-8 flex-col w-5/6 bg-gradient-to-r from-[#4285F4] to-[#3C83F9] w-full overflow-hidden">
  <MenuIcon onClick={toggleSidebar} className={`text-gray-200 absolute lg:hidden cursor-pointer left-4 top-4`}/>
