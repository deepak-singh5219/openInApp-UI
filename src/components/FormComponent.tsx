...
function FormComponent({ setAddPopup }: Props) {
  ...
  return (
    <div className=" bg-[#FAFAFA] relative w-full md:w-fit h-fit border p-5 rounded-lg m-32 mx-auto text-[#221e41]">
      ...
      <div className="mt-4 text-[0.8em] mb-10">
        <div className="flex gap-x-10">
          <div
            className={`px-28 py-2 border-b-4 ${
